...
@Serializable
data class Page(    // The pagination information    
@SerialName("pageInfo") 
...
@SerialName("airingSchedules") 
var airingSchedules: List<AiringSchedule>?,    // 
@SerialName("mediaTrends") 
...
var likes: List<User>?,)
@Serializable
data class PageInfo(    // The total number of items. Note: This value is not guaranteed to be accurate, do not rely on this for logic    
@SerialName("total") 
var total: Int?,    // The count on a page    
@SerialName("perPage") 
var perPage: Int?,    // The current page    
@SerialName("currentPage") 
var currentPage: Int?,    // The last page    
@SerialName("lastPage") 
var lastPage: Int?,    // If there is another page    
