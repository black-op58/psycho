...
data class Data(        
@SerialName("Page")        
val page: ActivityPage    ) : java.io.Serializable}
...
val activities: List<Activity>) : java.io.Serializable
@Serializable
data class Activity(    
...
@SerialName("likes")    
val likes: List<User>?,) : java.io.Serializable
@Serializable
...
data class Data(        
@SerialName("Page")        
val page: ReplyPage    ) : java.io.Serializable}

@Serializable
data class ReplyPage(    
@SerialName("activityReplies")    
val activityReplies: List<ActivityReply>) : java.io.Serializable
@Serializable
...
val toggleLike: LikeData    ) : java.io.Serializable}

@Serializable
data class LikeData(    
@SerialName("__typename")    
val typename: String) : java.io.Serializable