...
class CloudFlare(
override val location: FileUrl) : WebViewBottomDialog() {
    val cfTag = "cf_clearance"    
override var title = "Cloudflare Bypass"    
override val webViewClient = 
...
")                privateCallback.invoke(mapOf(cfTag to clearance))            }            super.onPageStarted(view, url, favicon)        }    }
