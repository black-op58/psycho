...
private suspend 
fun getAniZipId(anilistId: Int): String? {
return withContext(Dispatchers.IO) {
try {
...
@SerialName("mal_id") 
val malIdElement: JsonElement? = null,    
@SerialName("simkl_id") 
val simklId: Int? = null,    
@SerialName("themoviedb_id") 
val tmdbId: Int? = null,    
@SerialName("imdb_id") 
val imdbIdElement: JsonElement? = null,    
@SerialName("kitsu_id") 
val kitsuId: Int? = null,    
@SerialName("anidb_id") 
val anidbId: Int? = null,    
@SerialName("anime-planet_id") 
val animePlanetId: String? = null,    
@SerialName("animenewsnetwork_id") 
val annId: Int? = null,    
@SerialName("anisearch_id") 
val anisearchId: Int? = null,    
@SerialName("livechart_id") 
val livechartId: Int? = null,    
@SerialName("tvdb_id") 
val tvdbId: Int? = null,    
@SerialName("animecountdown_id") 
val animeCountdownId: Int? = null,    
@SerialName("tmdb_mappings") 
val tmdbMappings: Map<String, String>? = null,    
