...
import com.sanin.tv.databinding.ItemGenreBinding
import com.sanin.tv.loadImage
import com.sanin.tv.px
class GenreAdapter(    
private val type: String,    
private val big: Boolean = false) : RecyclerView.Adapter<GenreAdapter.GenreViewHolder>() {
...
if (!Anilist.adult) Toast.makeText(                                    itemView.context,                                    currActivity()?.getString(R.string.content_18),                                    Toast.LENGTH_SHORT                                ).show()                                it.putExtra("hentai", true)                            }                        },                    null                )            }        }    }
