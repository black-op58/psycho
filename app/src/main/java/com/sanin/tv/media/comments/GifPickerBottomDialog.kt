...
import com.sanin.tv.databinding.BottomSheetGifPickerBinding
import com.sanin.tv.databinding.ItemGifBinding
...
private val onClick: (String) -> Unit    ) : RecyclerView.Adapter<GifAdapter.GifViewHolder>() {
    class GifViewHolder(
val binding: ItemGifBinding) :            RecyclerView.ViewHolder(binding.root)        
