...
val scope = CoroutineScope(Dispatchers.IO + SupervisorJob())        binding.activityUserAvatar.loadImage(reply.user.avatar?.medium)
...
val userList = arrayListOf<User>()        reply.likes?.forEach { i ->
