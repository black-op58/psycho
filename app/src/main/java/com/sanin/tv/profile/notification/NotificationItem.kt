...
if (commentNotification) {                binding.notificationCoverUser.setImageResource(R.drawable.ic_sanintv_round)                binding.notificationCoverUser.scaleX = 1.4f
...
NotificationType.SUBSCRIPTION -> {                image(newRelease = true)                binding.notificationCoverUser.setOnClickListener {
