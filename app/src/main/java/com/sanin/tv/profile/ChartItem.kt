...
override fun bind(viewBinding: ItemChartBinding, position: Int) {        binding = viewBinding        binding.typeText.text = title        binding.root.visibility = View.INVISIBLE        binding.chartView.clipToPadding = true
