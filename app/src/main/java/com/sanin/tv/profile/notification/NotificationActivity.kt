...
import com.sanin.tv.databinding.ActivityNotificationBinding
...
import com.sanin.tv.profile.notification.NotificationFragment.Companion.newInstance
...
when (type) {
        USER -> {
        userCount = 0                            userTab?.badge = null                        }
MEDIA -> {
        mediaCount = 0                            mediaTab?.badge = null}
SUBSCRIPTION -> {
        subsCount = 0                            subsTab?.badge = null}
COMMENT -> {
        commentCount = 0
