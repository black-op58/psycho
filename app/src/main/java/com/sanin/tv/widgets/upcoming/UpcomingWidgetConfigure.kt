...
class UpcomingWidgetConfigure : AppCompatActivity(),    SimpleColorPicker.OnDialogResultListener {
...
val countdownTextColor = prefs.getInt(UpcomingWidget.PREF_COUNTDOWN_TEXT_COLOR, Color.WHITE)        (binding.countdownColorButton as MaterialButton).iconTint =            ColorStateList.valueOf(countdownTextColor)        binding.countdownColorButton.setOnClickListener {
    val tag = UpcomingWidget.PREF_COUNTDOWN_TEXT_COLOR            SimpleColorPicker.showColorDialog(this, getString(R.string.custom_theme), dialogTag = tag)        }        binding.useAppTheme.setOnCheckedChangeListener { _, isChecked ->            isMonetEnabled = isChecked
...
if (!isMonetEnabled) {
when (dialogTag) {                    UpcomingWidget.PREF_BACKGROUND_COLOR -> {                        getSharedPreferences(                            UpcomingWidget.PREFS_NAME,                            Context.MODE_PRIVATE                        ).edit()                            .putInt(                                UpcomingWidget.PREF_BACKGROUND_COLOR,                                extras.getInt(SimpleColorPicker.COLOR)                            )                            .apply()                        (binding.topBackgroundButton as MaterialButton).iconTint =                            ColorStateList.valueOf(extras.getInt(SimpleColorPicker.COLOR))                    }                    UpcomingWidget.PREF_BACKGROUND_FADE -> {                        getSharedPreferences(                            UpcomingWidget.PREFS_NAME,                            Context.MODE_PRIVATE                        ).edit()                            .putInt(                                UpcomingWidget.PREF_BACKGROUND_FADE,                                extras.getInt(SimpleColorPicker.COLOR)                            )                            .apply()                        (binding.bottomBackgroundButton as MaterialButton).iconTint =                            ColorStateList.valueOf(extras.getInt(SimpleColorPicker.COLOR))                    }                    UpcomingWidget.PREF_TITLE_TEXT_COLOR -> {                        getSharedPreferences(                            UpcomingWidget.PREFS_NAME,                            Context.MODE_PRIVATE                        ).edit()                            .putInt(                                UpcomingWidget.PREF_TITLE_TEXT_COLOR,                                extras.getInt(SimpleColorPicker.COLOR)                            )                            .apply()                        (binding.titleColorButton as MaterialButton).iconTint =                            ColorStateList.valueOf(extras.getInt(SimpleColorPicker.COLOR))                    }                    UpcomingWidget.PREF_COUNTDOWN_TEXT_COLOR -> {                        getSharedPreferences(                            UpcomingWidget.PREFS_NAME,                            Context.MODE_PRIVATE                        ).edit()                            .putInt(                                UpcomingWidget.PREF_COUNTDOWN_TEXT_COLOR,                                extras.getInt(SimpleColorPicker.COLOR)                            )                            .apply()                        (binding.countdownColorButton as MaterialButton).iconTint =                            ColorStateList.valueOf(extras.getInt(SimpleColorPicker.COLOR))                    }                }            }        }
return true    }}