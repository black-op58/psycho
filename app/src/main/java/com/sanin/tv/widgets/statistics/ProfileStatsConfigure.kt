...
val statsColor = prefs.getInt(ProfileStatsWidget.PREF_STATS_TEXT_COLOR, Color.WHITE)        (binding.statsColorButton as MaterialButton).iconTint = ColorStateList.valueOf(statsColor)        binding.statsColorButton.setOnClickListener {
    val tag = ProfileStatsWidget.PREF_STATS_TEXT_COLOR            SimpleColorPicker.showColorDialog(this, getString(R.string.custom_theme), dialogTag = tag)        }        binding.useAppTheme.setOnCheckedChangeListener { _, isChecked ->            isMonetEnabled = isChecked
...
if (!isMonetEnabled) {
    val prefs = getSharedPreferences(                    ProfileStatsWidget.getPrefsName(appWidgetId),                    Context.MODE_PRIVATE                )
when (dialogTag) {                    ProfileStatsWidget.PREF_BACKGROUND_COLOR -> {                        prefs.edit()                            .putInt(                                ProfileStatsWidget.PREF_BACKGROUND_COLOR,                                extras.getInt(SimpleColorPicker.COLOR)                            )                            .apply()                        (binding.topBackgroundButton as MaterialButton).iconTint =                            ColorStateList.valueOf(extras.getInt(SimpleColorPicker.COLOR))                    }                    ProfileStatsWidget.PREF_BACKGROUND_FADE -> {                        prefs.edit()                            .putInt(                                ProfileStatsWidget.PREF_BACKGROUND_FADE,                                extras.getInt(SimpleColorPicker.COLOR)                            )                            .apply()                        (binding.bottomBackgroundButton as MaterialButton).iconTint =                            ColorStateList.valueOf(extras.getInt(SimpleColorPicker.COLOR))                    }                    ProfileStatsWidget.PREF_TITLE_TEXT_COLOR -> {                        prefs.edit()                            .putInt(                                ProfileStatsWidget.PREF_TITLE_TEXT_COLOR,                                extras.getInt(SimpleColorPicker.COLOR)                            )                            .apply()                        (binding.titleColorButton as MaterialButton).iconTint =                            ColorStateList.valueOf(extras.getInt(SimpleColorPicker.COLOR))                    }                    ProfileStatsWidget.PREF_STATS_TEXT_COLOR -> {                        prefs.edit()                            .putInt(                                ProfileStatsWidget.PREF_STATS_TEXT_COLOR,                                extras.getInt(SimpleColorPicker.COLOR)                            )                            .apply()                        (binding.statsColorButton as MaterialButton).iconTint =                            ColorStateList.valueOf(extras.getInt(SimpleColorPicker.COLOR))                    }                }            }        }
return true    }}