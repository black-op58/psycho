...
class PreferencePackager {    //map one or more preference maps for import/export    
companion object {        /**         * @return a json string of the packed preferences         */        
